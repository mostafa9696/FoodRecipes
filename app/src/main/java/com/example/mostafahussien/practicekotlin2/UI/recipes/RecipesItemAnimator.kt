...
class RecipesItemAnimator : DefaultItemAnimator(){
    ...
    override fun animateChange(
        ...
        if (preInfo is RecipesItemHolderInfo) {
            val holder = newHolder as RecipeAdapter.RecipeViewHolder

            animateHeartButton(holder)
            if (RecipeAdapter.ACTION_LIKE_IMAGE_DOUBLE_CLICKED == preInfo.updateAction) {
    ...
    private fun animateHeartButton(holder: RecipeAdapter.RecipeViewHolder) {
    ...
    private fun animatePhotoLike(holder: RecipeAdapter.RecipeViewHolder) {
    ...
    private fun resetLikeAnimationState(holder: RecipeAdapter.RecipeViewHolder) {
